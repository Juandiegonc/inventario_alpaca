...
class TablaProductosDevoluciones {
    public function mostrarTablaProductosDevoluciones() {
        ...
        foreach ($productos as $key => $value) {
            ...
            $botones = "<div class='btn-group'><button class='btn btn-primary seleccionarProducto' idProducto='" . $value["id"] . "' codigoProducto='" . $value["codigo"] . "' descripcionProducto='" . $value["descripcion"] . "'>Seleccionar</button></div>";
...
$activarProductosDevoluciones = new TablaProductosDevoluciones();
$activarProductosDevoluciones->mostrarTablaProductosDevoluciones();
?>